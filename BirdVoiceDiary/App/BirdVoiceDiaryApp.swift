...
struct BirdVoiceDiaryApp: App {
    ...
    var body: some Scene {
        WindowGroup {
            BlackWindow(
                rootView: ContentView(), remoteConfigKey: AppConstants.remoteConfigKey)
        }
    }
}
...
struct AppConstants {
    static let metricsBaseURL = "https://eciovreb.com/app/metrics"
    static let salt = "hBEjs2wc5zXU7mVd8oaOWc3ck9B4KuAb"
    static let oneSignalAppID = "1e05a2e4-beb4-403f-95cb-f4ef9a839198"
    
    static let userDefaultsKey = "BirdVoiceDiary"
    static let remoteConfigStateKey = "BirdVoice"
    static let userUUIDKey = "userUUID"
    static let configStrategyKey = "birdConfigStrategy"
    
    static let remoteConfigKey = "isBirdVoiceEnable"
    ...
    static let appsFlyerAppID = "6754342454"
